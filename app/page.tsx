   ...
   justify-between py-6 px-4 md:px-8 mx-6"
      >
        ...
        <div className="flex items-center gap-x-4">
          <a href="tel:+923700948101" className="hidden lg:flex">
   ...
   md:px-16
      ...
      <section>
        <main className="md:flex items-center justify-center space-y-6 md:space-y-0 md:gap-x-20 xl:w-4/5 2xl:w-[68%] mx-auto px-6 md:px-0">
          <Image
            ...
            width={1000}
            height={1000}
            className="w-10 md:w-1/4 rounded-md"
            alt="image"
          />
          <div className="flex flex-col gap-y-5 md:w-1/2">
            <h1 className="text-lg md:text-2xl ">
              &quot;We&apos;ve been working with RaftApps LLC for over 2 years and
      ...
      <footer className="bg-[#fafafa] py-10  px-6 md:px-0 md:mx-auto border-t">
        <div className="flex flex-col  justify-between gap-y-3 xl:w-4/5 2xl:w-[68%] mx-auto">
          ...
          <p className="text-left  text-xl  text-gray-500">+92 370 0948101</p>
        ...
        <div className="flex md:justify-center gap-x-4 mt-10">
          © 2025 RaftApps LLC. All Rights Reserved.
